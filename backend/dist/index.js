...
const booking_resources_1 = __importDefault(require("./routes/booking-resources"));
const booking_tags_1 = __importDefault(require("./routes/booking-tags"));
...
app.use('/api/booking-resources', booking_resources_1.default);
app.use('/api/booking-tags', booking_tags_1.default);
